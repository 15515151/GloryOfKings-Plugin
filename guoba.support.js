    ...
    configInfo: {
      schemas: [
        ...
        },
        {
          ...
          label: '离线退避倍数',
          bottomHelpMessage: '玩家离线时把检查间隔拉长到几倍上面的轮询间隔。离线的号既不会开局也不会出新战绩，照高频查纯属白耗配额、更容易撞上 -30107。默认 5，即 2 分钟的间隔在离线满 3 小时后退到 10 分钟一次（不活跃 1 小时内 2 倍、1~3 小时 3 倍）；只给 #谁在打游戏 采集、不播报的影子订阅在此之上再放宽 3 倍（默认 30 分钟一轮）。代价是上线播报最坏晚这么久，期间「上线又下线」的短会话可能整段漏掉。填 1 = 关闭自适应，恒定按上面的间隔轮询。',
