...
const helpSections = [
  {
    ...
    list: [
      ...
      { cmd: '#营地wx全局登录', desc: '微信扫码登录，登录后可用 #营地观战' },
      { cmd: '#营地QQ全局登录', desc: 'QQ扫码登录，登录后可用 #营地观战' }
    ]
  },
  {
    title: '营地ID共享',
  ...
  },
  {
    ...
    list: [
      ...
      { cmd: '#营地分发部署', desc: '在本机装分发服务（pm2 托管），装完私聊给你管理密钥' },
      { cmd: '#营地分发服务', desc: '看分发服务跑没跑、各代码包的版本、发了几个令牌' },
      { cmd: '#营地分发发令牌', args: '<备注>', desc: '给别人签一个部署令牌；@一下群友就直接私聊发给 TA' },
      { cmd: '#营地分发接入方', desc: '看谁在用、下载了多少次、最后什么时候用的' },
      { cmd: '#营地分发吊销', args: '<序号>', desc: '踢掉某个令牌，对方就拉不到服务端代码了' },
      { cmd: '#营地分发地址', args: '<地址>', desc: '设置分发服务的外网地址（发令牌时拼给对方）' },
      { cmd: '#营地分发管理密钥', args: '<密钥>', desc: '分发服务跑在别的机器上时，配它才能远程签发 / 吊销' }
    ]
  },
  {
    title: '系统指令',
