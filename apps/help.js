...
const helpSections = [
  {
    ...
    list: [
      ...
      { cmd: '#营地wx登录', desc: '微信扫码登录获取登录态' },
      { cmd: '#营地QQ登录', desc: 'QQ扫码登录获取登录态' }
    ]
  },
  {
    title: '营地ID共享',
    ...
    list: [
      {
        cmd: '#开启营地ID共享',
        alias: ['#开启营地共享', '#打开营地共享'],
        desc: '把你绑的营地ID共享出去（默认不共享）。之后在别的装了王者插件、接了同一个共享库的机器人上，直接就能查，不用重新绑定'
      },
      {
        cmd: '#关闭营地ID共享',
        alias: ['#取消营地共享'],
  ...
  },
  {
    ...
    list: [
      ...
      { cmd: '#谁在打游戏', alias: ['#谁在打王者', '#谁在玩王者', '#谁在上号', '#谁在排位', '#王者在线', '#王者在线列表', '#王者在线状态', '#在线列表'], desc: '本群谁在对局中、打了多久；退群自动出名单，不额外发请求' },
  ...
  },
  {
    ...
    list: [
      ...
      { cmd: '#营地wx全局登录', desc: '微信扫码获取全局公共登录态' },
      { cmd: '#营地QQ全局登录', desc: 'QQ扫码获取全局公共登录态' },
      ...
      { cmd: '#营地共享库部署', alias: ['#营地共享部署'], desc: '一键在本机搭一个共享库（pm2 托管），搭完会私聊给你令牌' },
      { cmd: '#营地共享库状态', desc: '看本机这个共享库跑没跑、库里有多少人' },
      { cmd: '#营地共享库发令牌', args: '<备注>', alias: ['#营地共享发令牌'], desc: '给别人的机器人签一个令牌，回复里直接拼好让对方发的话' },
      { cmd: '#营地共享库接入方', alias: ['#营地共享接入方'], desc: '看谁在用你的共享库，带最后请求时间' },
      { cmd: '#营地共享库吊销', args: '<序号>', alias: ['#营地共享吊销'], desc: '踢掉某个接入方，对方就查不了你这个库了' },
      { cmd: '#营地共享库同步', alias: ['#营地共享同步'], desc: '把本机绑定过的人全量对一遍账，谁没传上去补谁' },
      { cmd: '#营地共享库卸载', alias: ['#营地共享卸载'], desc: '停掉共享库服务，密钥和数据都保留' },
      { cmd: '#接入营地共享库', alias: ['#关闭营地共享库'], desc: '接入 / 关闭某个共享库，自己搭的和别人搭的填法一样' },
      { cmd: '#营地共享库地址', args: '<地址>', desc: '设置共享库地址（http/https）' },
      { cmd: '#营地共享库令牌', args: '<令牌>', desc: '设置共享库签发的令牌' },
